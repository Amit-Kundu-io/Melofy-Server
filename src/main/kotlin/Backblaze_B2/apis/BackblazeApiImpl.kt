...
class BackblazeApiImpl(
    ...
    private companion object {
        ...
        private const val GET_DOWNLOAD_AUTHORIZATION = "/b2api/v4/b2_get_download_authorization"
    }
    ...
    override suspend fun startLargeFile(
    ...
    override suspend fun getUploadPartUrl(
    ...
    override suspend fun uploadPart(
        ...
        require(chunk.length > 0) {
            "Part content length must be greater than 0."
        }
    ...
    override suspend fun finishLargeFile(
    ...
    override suspend fun cancelLargeFile(
    ...
    override suspend fun generateWatchUrl(
        fileName: String,
